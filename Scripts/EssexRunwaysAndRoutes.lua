...
-- runways/Cats inbetween Hold back start and connect to front of ship not where the cat/start point connectors are
	{{51.5047,  16.95,    9.331755}, 		000, 		    	  76.9248, 		    20.0, 		0, 2.5, 2.8, 3.0, 3.0, 3.2, 3.5},  --  Cat 1 location
	{{51.6597,  16.95,  -12.076300}, 		003, 		    	  76.9248, 	        20.0, 		0, 2.5, 2.8, 3.0, 3.0, 3.2, 3.5},  --  Cat 2 location
	};
...
GT.TaxiRoutes = 
{
	{ -- 1 parking spot
		...
		{{ -19.574, 16.95, 23.233 }, 3.0},
		{{ -28.441, 16.95, -8 },		2.0}, -- WP 4
		{{ -28.481, 16.95, 3 },		2.0,	1.0*60.0} -- Park . 1.0*60 = time for pilot to despawn 60 seconds, this is an option
	},
	{ -- 2 parking spot 
		{{ -19.574, 16.95, 23.233 }, 3.0},
		{{ -15.209, 16.95, -8 },		2.0},
		{{ -15.209, 16.95, 3 },		2.0,	1.0*60.0}
	},
	{ -- 3 parking spot
		{{ -19.574, 16.95, 23.233 }, 3.0},
		{{ -1.7325, 16.95, -8 },		2.0},
		{{ -1.7325, 16.95, 3 },		2.0,	1.0*60.0}
	},
	{ -- 4 parking spot
		{{ -19.574, 16.95, 23.233 }, 3.0},
		{{ 12.112, 16.95, -8 },		2.0},
		{{ 12.112, 16.95, 3 },		2.0,	1.0*60.0}
	},
	{ -- 5 parking spot
		{{ -19.574, 16.95, 23.233 }, 3.0},
		{{ 26.101, 16.95, -8.00 }, 2.0}, -- WP1
		{{ 26.101, 16.95, 3 }, 1.0, 1.0 * 60.0}
	}
}
...
{		
	...
	{ RunwayIdx = 2, Points =
		{ -- 6 spawn 
			...
			{{51.5,       16.95,    -11.833},       1.0},
 			{{52.15,      16.95,    -11.833},       1.0} -- Hold back start
		}
	},
	{ RunwayIdx = 1, Points =
		{ -- 7 spawn 
